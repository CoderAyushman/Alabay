...
const ProjectVision = () => {
  return (
    <div className="flex-col  mt-24 text-center ">
      <h1 className="font-custom text-[#FFA800] md:text-7xl lg:text-9xl mb-14">
        project vision
      </h1>
      <div className="flex-col bg-gradient-to-b from-[#FFC700] via-[#FFF280]  to-[#FFC700]    items-center justify-center pt-3  shadow-lg skew-custom2 px-7 py-20 h-min ">
        <img
